...
**My goals**: Master modern programming practices, contribute to meaningful projects, and continuously expand my technical skillset.
...
- **Tools & Methodologies**: `Git` (version control), `Visual Studio` (IDE)
